...
public class HMMRContainerControlCard extends AppCompatActivity implements SummaryBehavior {
    ...
    private final String CONTAINER_READ_DATA_BASE = Shared.nameHMMR_SUMMARY;
    private final String CONTAINER_WRITE_DATA_BASE = Shared.nameDefectHMMR_Container;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hmmr_2020_container_control_card);
        ...
        containers.setState();
//        TODO
//        Добавили чтобы вставить пустые данные в эти колонки
        containers.setState(item2, "");
        containers.setState(item3, "");

        initializeListeners();

        //  Находим нашу заветную кнопочку Save
        Button save = findViewById(R.id.hmmr_container_save);
    ...
    public void initializeItems() {
        item1 = new Item(this,   R.id.hmmr_container_controlCard_1, true);
        item2 = new Item(this,   R.id.hmmr_container_controlCard_2, true);
        item3 = new Item(this,   R.id.hmmr_container_controlCard_3, true);
        item4 = new Item(this,   R.id.hmmr_container_controlCard_4, true);
//        item5 = new Item(this,  R.id.hmmr_container_controlCard_5, true);
        item6 = new Item(this,   R.id.hmmr_container_controlCard_6, true);
        item7 = new Item(this,   R.id.hmmr_container_controlCard_7, true);
        item8 = new Item(this,   R.id.hmmr_container_controlCard_8, true);
        item9 = new Item(this,   R.id.hmmr_container_controlCard_9, true);
        item10 = new Item(this,  R.id.hmmr_container_controlCard_10, true);
        item11 = new Item(this,  R.id.hmmr_container_controlCard_11, true);
        item12 = new Item(this,  R.id.hmmr_container_controlCard_12, true);
        item13 = new Item(this,  R.id.hmmr_container_controlCard_13, true);
        item14 = new Item(this,  R.id.hmmr_container_controlCard_14, true);
        item15 = new Item(this,  R.id.hmmr_container_controlCard_15, false);
        item16 = new Item(this,  R.id.hmmr_container_controlCard_16, true);
        item17 = new Item(this,  R.id.hmmr_container_controlCard_17, true);
        item18 = new Item(this,  R.id.hmmr_container_controlCard_18, true);
        item19 = new Item(this,  R.id.hmmr_container_controlCard_19, true);
        item20 = new Item(this,  R.id.hmmr_container_controlCard_20, true);

        item22 = new Item(this,  R.id.hmmr_container_controlCard_22, true);
        item22H = new Item(this, R.id.hmmr_container_controlCard_22_h, true, new Item[]{item22});
        item21 = new Item(this,  R.id.hmmr_container_controlCard_21, true);

        item23 = new Item(this,  R.id.hmmr_container_controlCard_23, true);
        item24 = new Item(this,  R.id.hmmr_container_controlCard_24, true);
//        item25 = new Item(this, R.id.hmmr_container_controlCard_25, true);
//        item26 = new Item(this, R.id.hmmr_container_controlCard_26, true);
//        item27 = new Item(this, R.id.hmmr_container_controlCard_27, true);
//        item28 = new Item(this, R.id.hmmr_container_controlCard_28, true);
//        item29 = new Item(this, R.id.hmmr_container_controlCard_29, true);
//        item30 = new Item(this, R.id.hmmr_container_controlCard_30, true);
//        item31 = new Item(this, R.id.hmmr_container_controlCard_31, true);
//        item32 = new Item(this, R.id.hmmr_container_controlCard_32, true);
        item33 = new Item(this,  R.id.hmmr_container_controlCard_33, true);

        item35 = new Item(this,  R.id.hmmr_container_controlCard_35, true);
        item35H = new Item(this, R.id.hmmr_container_controlCard_35_h, true, new Item[]{item35});
        item34 = new Item(this,  R.id.hmmr_container_controlCard_34, true);

        item37 = new Item(this,  R.id.hmmr_container_controlCard_37, true);
        item37H = new Item(this, R.id.hmmr_container_controlCard_37_h, true, new Item[]{item37});
        item36 = new Item(this,  R.id.hmmr_container_controlCard_36, true);

        item39 = new Item(this,  R.id.hmmr_container_controlCard_39, true);
        item39H = new Item(this, R.id.hmmr_container_controlCard_39_h, true, new Item[]{item39});
        item38 = new Item(this,  R.id.hmmr_container_controlCard_38, true);
        item41 = new Item(this,  R.id.hmmr_container_controlCard_41, true);
        item41H = new Item(this, R.id.hmmr_container_controlCard_41_h, true, new Item[]{item41});
        item40 = new Item(this,  R.id.hmmr_container_controlCard_40, true);
        item43 = new Item(this,  R.id.hmmr_container_controlCard_43, true);
        item43H = new Item(this, R.id.hmmr_container_controlCard_43_h, true, new Item[]{item43});
        item42 = new Item(this,  R.id.hmmr_container_controlCard_42, true);
        item44 = new Item(this,  R.id.hmmr_container_controlCard_44, true);
        item46 = new Item(this,  R.id.hmmr_container_controlCard_46, true);
        item47 = new Item(this,  R.id.hmmr_container_controlCard_47, true);
        item48 = new Item(this,  R.id.hmmr_container_controlCard_48, true);
        item49 = new Item(this,  R.id.hmmr_container_controlCard_49, true);
        item50 = new Item(this,  R.id.hmmr_container_controlCard_50, true);
        item51 = new Item(this,  R.id.hmmr_container_controlCard_51, true);
        item52 = new Item(this,  R.id.hmmr_container_controlCard_52, true);
        item53 = new Item(this,  R.id.hmmr_container_controlCard_53, true);
        item45 = new Item(this,  R.id.hmmr_container_controlCard_45, true,
                new Item[]{item46, item47, item48, item49, item50, item51, item52, item53});

        item54 = new Item(this,  R.id.hmmr_container_controlCard_54, true);
        item55 = new Item(this,  R.id.hmmr_container_controlCard_55, true);
        item56 = new Item(this,  R.id.hmmr_container_controlCard_56, true);
        item57 = new Item(this,  R.id.hmmr_container_controlCard_57, true);
        item58 = new Item(this,  R.id.hmmr_container_controlCard_58, true);
//        item59 = new Item(this, R.id.hmmr_container_controlCard_59, true);
        item60 = new Item(this,  R.id.hmmr_container_controlCard_60, true);
        item61 = new Item(this,  R.id.hmmr_container_controlCard_61, true);
        item62 = new Item(this,  R.id.hmmr_container_controlCard_62, true);
        item63 = new Item(this,  R.id.hmmr_container_controlCard_63, true);
        item64 = new Item(this,  R.id.hmmr_container_controlCard_64, true);
        item65 = new Item(this,  R.id.hmmr_container_controlCard_65, true);
        item66 = new Item(this,  R.id.hmmr_container_controlCard_66, true);

        item67 = new Item(this,  R.id.hmmr_container_controlCard_67, true);
        item68 = new Item(this,  R.id.hmmr_container_controlCard_68, true);
        item69 = new Item(this,  R.id.hmmr_container_controlCard_69, true);
        item70 = new Item(this,  R.id.hmmr_container_controlCard_70, true);
        item71 = new Item(this,  R.id.hmmr_container_controlCard_71, true);
        item72 = new Item(this,  R.id.hmmr_container_controlCard_72, true);
        item73 = new Item(this,  R.id.hmmr_container_controlCard_73, true);
        item74 = new Item(this,  R.id.hmmr_container_controlCard_74, true);

        item101 = new Item(this, R.id.hmmr_pump_defectTree_101, true);

//        Дефекты добавляемые через конпку + с эдитекстом
//        item102 = new Item(this, R.id.hmmr_container_controlCard_102, true, new Item[]{item67});
//        item102.hidden(View.GONE);
//        item103 = new Item(this, R.id.hmmr_container_controlCard_103, true);
//        item104 = new Item(this, R.id.hmmr_container_controlCard_104, true, new Item[]{item68});
//        item104.hidden(View.GONE);
//        item105 = new Item(this, R.id.hmmr_container_controlCard_105, true);
//        item106 = new Item(this, R.id.hmmr_container_controlCard_106, true, new Item[]{item69});
//        item106.hidden(View.GONE);
//        item107 = new Item(this, R.id.hmmr_container_controlCard_107, true);
//        item108 = new Item(this, R.id.hmmr_container_controlCard_108, true, new Item[]{item70});
//        item108.hidden(View.GONE);
//        item109 = new Item(this, R.id.hmmr_container_controlCard_109, true);
//        item110 = new Item(this, R.id.hmmr_container_controlCard_110, true, new Item[]{item71});
//        item110.hidden(View.GONE);
//        item111 = new Item(this, R.id.hmmr_container_controlCard_111, true);
//        item112 = new Item(this, R.id.hmmr_container_controlCard_112, true, new Item[]{item72});
//        item112.hidden(View.GONE);
//        item113 = new Item(this, R.id.hmmr_container_controlCard_113, true);
//        item114 = new Item(this, R.id.hmmr_container_controlCard_114, true, new Item[]{item73});
//        item114.hidden(View.GONE);
//        item115 = new Item(this, R.id.hmmr_container_controlCard_115, true);
//        item116 = new Item(this, R.id.hmmr_container_controlCard_116, true, new Item[]{item74});
//        item116.hidden(View.GONE);
//        item117 = new Item(this, R.id.hmmr_container_controlCard_117, true);
    }
...
//        containers.addItem(59, item59);
    ...
    public void initializeListeners(){
        ...
        RadioGroupHandler.setActionShowDialog(this, R.id.hmmr_container_controlCard_16_1, R.drawable.conteiner_on_the_ground);
        RadioGroupHandler.setActionShowDialog(this, R.id.hmmr_container_controlCard_16_2, R.drawable.container_rack_supports);
        RadioGroupHandler.setActionShowDialog(this, R.id.hmmr_container_controlCard_16_3, R.drawable.container_paw_supports);
        RadioGroupHandler.setActionShowDialog(this, R.id.hmmr_container_controlCard_16_4, R.drawable.container_saddle_supports);
        RadioGroupHandler.setActionShowDialog(this, R.id.hmmr_container_controlCard_16_5, R.drawable.container_metal_supporting_structure);
        RadioGroupHandler.setActionShowDialog(this, R.id.hmmr_container_controlCard_16_6, R.drawable.container_conical_support);
        RadioGroupHandler.setActionShowDialog(this, R.id.hmmr_container_controlCard_16_7, R.drawable.container_cylindrical_support);
        RadioGroupHandler.setActionShowDialog(this, R.id.hmmr_container_controlCard_16_8, R.drawable.container_ring_supports);

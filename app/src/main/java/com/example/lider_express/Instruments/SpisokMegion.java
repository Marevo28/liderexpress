...
public class SpisokMegion extends AppCompatActivity {
    TextView selection;
    String select;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (PEOPLE){
            case "expertsObject":
                spisochek = getResources().getStringArray(R.array.megion_experts);  // создаем адаптер
                break;
            case "expertsNK":
                spisochek = getResources().getStringArray(R.array.megion_experts);  // создаем адаптер
                break;
        ...
        butSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent IntentSvodnaya = new Intent(SpisokMegion.this, MegionSvodnaya.class);//данны дял передачи

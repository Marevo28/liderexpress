                    ...
                    public boolean onPreferenceChange(Preference arg0, Object newValue) {
                        if( pref.getKey().equals("preference_camera_api") ) {
                            ...
                            if( list_pref.getValue().equals(newValue) ) {
                                ...
                                MainCamera2 main_activity = (MainCamera2)MyPreferenceFragment.this.getActivity();
            ...
            pref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference arg0) {
                    if( pref.getKey().equals("preference_save_settings") ) {
                        ...
                        final MainCamera2 main_activity = (MainCamera2)MyPreferenceFragment.this.getActivity();
                        try {

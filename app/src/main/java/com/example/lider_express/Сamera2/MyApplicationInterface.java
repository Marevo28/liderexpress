...
import com.example.lider_express.Сamera2.preview.BasicApplicationInterface;
...
import com.example.lider_express.Сamera2.ui.DrawPreview;
...
public class MyApplicationInterface extends BasicApplicationInterface {
    ...
    MyApplicationInterface(MainCamera2 main_activity, Bundle savedInstanceState) {
        long debug_time = 0;
        if( MyDebug.LOG ) {

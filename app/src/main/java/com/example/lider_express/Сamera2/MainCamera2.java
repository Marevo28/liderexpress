package com.example.lider_express.Сamera2;
...
import com.example.lider_express.Сamera2.cameracontroller.CameraController;
import com.example.lider_express.Сamera2.cameracontroller.CameraControllerManager2;
import com.example.lider_express.Сamera2.preview.Preview;
import com.example.lider_express.Сamera2.preview.VideoProfile;
import com.example.lider_express.Сamera2.remotecontrol.BluetoothRemoteControl;
import com.example.lider_express.Сamera2.ui.FolderChooserDialog;
import com.example.lider_express.Сamera2.ui.MainUI;
import com.example.lider_express.Сamera2.ui.ManualSeekbars;
 ...
 */
public class MainCamera2 extends Activity {
    private static final String TAG = "MainCamera2";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        orientationEventListener = new OrientationEventListener(this) {
            ...
            public void onOrientationChanged(int orientation) {
                MainCamera2.this.mainUI.onOrientationChanged(orientation);
            }
        };
        if( MyDebug.LOG )
        ...
        new Thread(new Runnable() {
            public void run() {
                textToSpeech = new TextToSpeech(MainCamera2.this, new TextToSpeech.OnInitListener() {
                    @Override
    ...
    private final BroadcastReceiver cameraReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            MainCamera2.this.takePicture(false);
        }
    };
    ...
    public void clickedTextStamp(View view) {
        ...
        alertDialog.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(MainCamera2.this);
                SharedPreferences.Editor editor = sharedPreferences.edit();
    ...
    public void updateGalleryIcon() {
        ...
        new AsyncTask<Void, Void, Bitmap>() {
            ...
            protected Bitmap doInBackground(Void... params) {
                ...
                KeyguardManager keyguard_manager = (KeyguardManager) MainCamera2.this.getSystemService(Context.KEYGUARD_SERVICE);
    ...
    public static class MyFolderChooserDialog extends FolderChooserDialog {
        ...
        public void onDismiss(DialogInterface dialog) {
            ...
            MainCamera2 main_activity = (MainCamera2)this.getActivity();
        ...
        alertDialog.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if( which == clear_index ) {
                    ...
                    new AlertDialog.Builder(MainCamera2.this)
    ...
    private class MyGestureDetector extends SimpleOnGestureListener {
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            try {
                ...
                final ViewConfiguration vc = ViewConfiguration.get(MainCamera2.this);

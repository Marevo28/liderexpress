...
public class Megion2020 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PickExpert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent IntentSittings = new Intent(Megion2020.this, Spisok.class);
    ...
    public void setDateExp(View v) {
        new DatePickerDialog(Megion2020.this, a, dateAndTime.get(Calendar.YEAR), dateAndTime.get(Calendar.MONTH), dateAndTime.get(Calendar.DAY_OF_MONTH)).show();
    }
    ...
    public void setDateSpec(View v) {
        new DatePickerDialog(Megion2020.this, b, dateAndTime.get(Calendar.YEAR), dateAndTime.get(Calendar.MONTH), dateAndTime.get(Calendar.DAY_OF_MONTH)).show();
    }
    ...
    public void setDateNachOstanov(View v) {
        new DatePickerDialog(Megion2020.this, c, dateAndTime.get(Calendar.YEAR), dateAndTime.get(Calendar.MONTH), dateAndTime.get(Calendar.DAY_OF_MONTH)).show();
    }
    ...
    public void setDateKonOstanov(View v) {
        new DatePickerDialog(Megion2020.this, d, dateAndTime.get(Calendar.YEAR), dateAndTime.get(Calendar.MONTH), dateAndTime.get(Calendar.DAY_OF_MONTH)).show();
    }
    ...
    public void setDataNegotovnosti(View v) {
        new DatePickerDialog(Megion2020.this, e, dateAndTime.get(Calendar.YEAR), dateAndTime.get(Calendar.MONTH), dateAndTime.get(Calendar.DAY_OF_MONTH)).show();
    }
    ...
    public void setTextDataNK(View v) {
        new DatePickerDialog(Megion2020.this, f, dateAndTime.get(Calendar.YEAR), dateAndTime.get(Calendar.MONTH), dateAndTime.get(Calendar.DAY_OF_MONTH)).show();
    }
